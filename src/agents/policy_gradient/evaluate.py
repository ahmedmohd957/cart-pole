...
for variant in variants:
    ...
    for seed in [1, 2, 3, 5, 8]:
        env.reset(seed=seed)
        episode_rewards, average_rewards = evaluate_agent(env, episodes=200, max_steps=1000, model_path="data/trained_policy.pth")
...
# Plot results
plot_robustness_performance("REINFORCE", variants, average_rewards_data)
